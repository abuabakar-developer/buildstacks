...
import { Users, MessageCircle, Check, ArrowRight } from "lucide-react";
...
const features = [
  {
    ...
    desc: "Work together with your team instantly, no matter where you are.",
  ...
  },
  {
    ...
    desc: "Communicate, share updates, and resolve issues in one place.",
  ...
  },
  {
    ...
    desc: "Assign, track, and complete tasks as a team with clarity.",
      ...
      <div className="flex-1">
        ...
        <section className="max-w-6xl mx-auto px-4 pt-24 pb-8 flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex-1 w-full">
            ...
            >
              Team Collaboration, <span className="text-black">Elevated</span>
            </motion.h1>
            <motion.p
            ...
            >
              Empower your construction teams to communicate, coordinate, and succeed together. Experience seamless collaboration with modern tools built for teamwork.
            </motion.p>
        ...
        <section className="relative max-w-7xl mx-auto mb-24 px-4 pt-4 pb-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-black/70 font-inter max-w-2xl mx-auto">Unlock the power of teamwork with these essential collaboration tools.</p>
          </div>
          <motion.div
            initial="hidden"
            whileInView="visible"
                ...
                >
                  ...
                  <div className={`hidden lg:block pointer-events-none absolute left-1/2 -bottom-7 w-3/4 h-3 z-0 transition-all duration-500 ${activeCard === index ? 'blur-md opacity-80' : 'opacity-0'}`} style={{transform: 'translateX(-50%)'}}>
                    <div className="w-full h-full rounded-full" style={{
                      background: 'linear-gradient(90deg, rgba(168,85,247,0.25) 0%, rgba(109,40,217,0.45) 50%, rgba(168,85,247,0.25) 100%)',
                      filter: 'blur(6px)'
                    }}></div>
                  </div>
                </div>
