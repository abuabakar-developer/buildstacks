...
const features = [
  {
    ...
    title: "Data Security",
    desc: "Protect sensitive project data with advanced encryption and controls.",
  ...
  },
  {
    ...
    desc: "Stay audit-ready with automated compliance documentation.",
  ...
  },
  {
    ...
    desc: "Control who can view, edit, and share critical information.",
      ...
      <div className="flex-1">
        ...
        <section className="max-w-6xl mx-auto px-4 pt-24 pb-8 flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex-1 w-full">
            ...
            >
              Security & Compliance, <span className="text-black">Guaranteed</span>
            </motion.h1>
            <motion.p
            ...
            >
              Ensure your construction projects meet the highest standards for data security and regulatory compliance. Stay protected and audit-ready at every step.
            </motion.p>
        ...
        <section className="relative max-w-7xl mx-auto mb-24 px-4 pt-4 pb-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-black/70 font-inter max-w-2xl mx-auto">Protect your data and stay compliant with these essential tools.</p>
          </div>
          <motion.div
            initial="hidden"
            whileInView="visible"
                ...
                >
                  ...
                  <div className={`hidden lg:block pointer-events-none absolute left-1/2 -bottom-7 w-3/4 h-3 z-0 transition-all duration-500 ${activeCard === index ? 'blur-md opacity-80' : 'opacity-0'}`} style={{transform: 'translateX(-50%)'}}>
                    <div className="w-full h-full rounded-full" style={{
                      background: 'linear-gradient(90deg, rgba(34,197,94,0.25) 0%, rgba(16,185,129,0.45) 50%, rgba(34,197,94,0.25) 100%)',
                      filter: 'blur(6px)'
                    }}></div>
                  </div>
                </div>
